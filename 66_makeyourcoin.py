...
for coin in coins:
    arguments = [coin, coin.value, coin.colour, coin.num_edges, coin.diameter, coin.thickness, coin.mass]

    string = "{} - Value:{}, colour: {}, number of edges:{}, diameter(mm):{}, thickness:{}, mass(g):{}".format(*arguments)
    print(string)
